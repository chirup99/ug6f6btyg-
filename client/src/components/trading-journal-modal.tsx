        ...
        <div className="py-2 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex items-center gap-2 p-2 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
              ...
              <div>
                <p className="text-xs font-medium leading-tight">Daily Trade Tracking</p>
                <p className="text-[10px] text-gray-500 leading-tight">Record &amp; monitor all your trades</p>
              </div>
            </div>
            <div className="flex items-center gap-2 p-2 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
              <BarChart3 className="h-4 w-4 text-green-500 shrink-0" />
              <div>
                <p className="text-xs font-medium leading-tight">AI Performance Analysis</p>
                <p className="text-[10px] text-gray-500 leading-tight">Detailed P&amp;L &amp; statistics</p>
              </div>
            </div>
          </div>

          {/* Improve Your Trading — unchanged */}
          ...
          {/* 93% stats — unchanged original full text */}
