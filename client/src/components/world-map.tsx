...
> = {
  ...
  INDIA: {
    ...
    youtubeChannels: [
      { name: "CNBC TV18", channelId: "UCQ8TUkc6qs8mGKKNjOmRTXw", channelUrl: "https://www.youtube.com/@CNBC-TV18" },
...
function RegionDialog({
  ...
  const market = marketData?.[region as keyof typeof marketData];
...
export function WorldMap() {
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      >
        <div className="flex items-center gap-6 bg-[#1a1a1a] p-4 rounded-2xl border border-green-500/20 shadow-[0_0_20px_rgba(0,0,0,0.6)] pl-[20px] pr-[20px] text-[12px] text-left font-normal pt-[2px] pb-[2px]">
          {/* Radar Unit */}
