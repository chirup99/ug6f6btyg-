              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    {!isEmailLoading && <ArrowRight size={16} className="ml-2" />}
                  </Button>
                  ...
                  {isLogin && (
                    <button
                      ...
                      className="w-full text-right text-xs text-gray-500 hover:text-gray-300"
                    >
                      Forgot password?
                    </button>
                  )}
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full bg-white hover:bg-gray-100 text-black h-11 rounded-xl border-0 flex items-center justify-center gap-2 disabled:opacity-70"
                  >
                    {isGoogleLoading ? (
