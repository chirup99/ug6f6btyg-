...
export function TradeDurationAnalysis({ filteredHeatmapData, theme }: TradeDurationAnalysisProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
      {/* Header */}
      <div className="px-6 py-5 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-slate-800/80 dark:to-slate-800 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Holding time patterns — see exactly where time costs you money</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          {hasDur && grade !== '-' && (
            <div className={`px-3 py-1.5 rounded-xl text-sm font-black border ${gradeColor}`}>
              Exit Grade: {grade}
            </div>
          )}
          {hasDur && (
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 rounded-2xl p-4">
                ...
                <p className="text-[10px] text-slate-400 mt-1">{lossTrades.length} losing trades</p>
              </div>
              <div className="bg-green-50 dark:bg-green-500/10 border border-green-100 dark:border-green-500/20 rounded-2xl p-4">
                ...
                <p className="text-[10px] text-slate-400 mt-1">{profTrades.length} profitable trades</p>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className={`rounded-2xl p-4 border flex gap-3 items-start ${isOverHolding?'bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/30':'bg-green-50 dark:bg-green-500/10 border-green-200 dark:border-green-500/30'}`}>
                ...
                <div>
                  <p className="font-bold text-sm text-slate-800 dark:text-slate-200">{isOverHolding?'Holding Losses Too Long':'Exits Are Disciplined'}</p>
              ...
              <div className="rounded-2xl p-4 border bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/30 flex gap-3 items-start">
                ...
                <div>
                  <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Your Profit Window</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
              ...
              <div className={`rounded-2xl p-4 border flex gap-3 items-start ${sums.filter(d=>d.avgLossDurMs>d.avgProfitDurMs*1.3).length>sums.length/2?'bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/30':'bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-500/30'}`}>
              ...
              <div className={`rounded-2xl p-4 border flex gap-3 items-start ${bestBucket[1].wins>0?'bg-purple-50 dark:bg-purple-500/10 border-purple-200 dark:border-purple-500/30':'bg-slate-50 dark:bg-slate-800 border-slate-100 dark:border-slate-700'}`}>
                <span className="text-2xl">🎯</span>
                <div>
                  <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Best Holding Sweet Spot</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
              ...
              <div className="rounded-2xl p-4 border bg-slate-50 dark:bg-slate-800 border-slate-100 dark:border-slate-700 flex gap-3 items-start">
                <span className="text-2xl">💡</span>
                <div>
                  <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Time-based Stop Rule</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
              ...
              <div className={`rounded-2xl p-4 border flex gap-3 items-start ${grade==='A'||grade==='B'?'bg-green-50 dark:bg-green-500/10 border-green-200 dark:border-green-500/30':'bg-orange-50 dark:bg-orange-500/10 border-orange-200 dark:border-orange-500/30'}`}>
                <span className="text-2xl">{grade==='A'?'🏆':grade==='B'?'⭐':grade==='C'?'📈':'🚨'}</span>
                <div>
                  <p className="font-bold text-sm text-slate-800 dark:text-slate-200">Exit Discipline Grade: {grade}</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
