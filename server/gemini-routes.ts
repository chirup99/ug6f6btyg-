    ...
    try {
      ...
      try {
        ...
        const mockPatternMatches: any[] = [
          // Example pattern match that would come from pattern scanner
          /*
          {
      ...
      const context = {
        ...
        features: {
          ...
          patternScanner: "Chart pattern recognition with 50%+ confidence validation"
        },
        ...
        supportedFeatures: [
          ...
          "chart pattern matching with 50% confidence threshold",
...
Please provide a helpful, comprehensive response.`;
      ...
      // Ultra-Smart Strategy Detection for #1 Trading AI (50% text match intelligence)
      ...
      if (isStrategyRequest) {
        ...
        const strategyCode = `// ${finalStrategy} - Generated by Trading AI
...
Need help setting up risk parameters for your account size?`;
        ...
        response = `🤖 **Trading AI Trading Assistant**
...
What can I help you with today?`;
  ...
  app.post("/api/gemini/chat", async (req, res) => {
    try {
      ...
      if (isNewsRequest) {
        try {
          console.log(`📰 Trading AI: Fetching news-based stock recommendations`);
